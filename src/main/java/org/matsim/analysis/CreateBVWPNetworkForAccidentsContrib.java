...
//This class has to be run before starting the simulation as the resulting network has to be used for the matSim run
public class CreateBVWPNetworkForAccidentsContrib {

	private static final Logger log = LogManager.getLogger(org.matsim.analysis.CreateBVWPNetworkForAccidentsContrib.class);
